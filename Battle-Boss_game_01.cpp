...
printf("|                                                                                                                                                                       \n");
printf("|                                                                                                                                                                       \n");
printf("|                                                  - เกมนี้เป็นเกมต่อสู้ผ่านด่าน ท่านต้องทำการต่อสู้กับบอสในเเต่ละด่านไปจนถึงบอสตัวสุดท้าย                                                 \n");
printf("|                                                                                                                                                                       \n");
printf("|                                                  - หลังจากต่อสู้กับบอสในเเต่ละด่านจบท่านจะได้รับเงินเเล้วจะมีร้านค้าให้ ท่านสามารถซื้อของ                                                \n");
printf("|                                                    เพื่อที่จะเอาไปอัพเกรดตัวละครเพื่อที่จะต่อสู้กับบอสในด่านต่อไปได้                                                                  \n");
printf("|                                                                                                                                                                       \n");
printf("|                                                  - การสู้กับบอสในเเต่ละด่านสามาถใช้ ของที่ซื้อมาจากร้านค้า Damage ของอาวุธที่ซื้อเป็นเเบบสุ่ม                                             \n");
printf("|                                                                                                                                                                       \n");
printf("|                                                  - ทุกครั้งที่เริ่มต่อสู้กับบอส จะทำการรักษาตัวละครเราให้เลือดเต็ม                                                                    \n");
printf("|                                                                                                                                                                       \n");
printf("|                                                                                                                                                                       \n");
printf("|                                                                                                                                                                       \n");
printf("|                                                                                                                                                                       \n");
